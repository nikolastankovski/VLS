...
namespace VLS.API.Controllers
{
    ...
    public class EmployeesController : ControllerBase
    {
        ...
        public EmployeesController(IEmployeeRepository employeeRepo, EmployeeService employeeService, LoggingService logService)
        {
        ...
        public async Task<IActionResult> GetAll()
        {
            try
            {
                return Ok(await _employeeRepo.GetAllAsync());
            }
            catch (Exception e)
            {
        ...
        public async Task<IActionResult> GetById(int id)
        {
            try
            {
                Employee? entity = await _employeeRepo.GetByIdAsync(id);
